...
#define MAX_THREAD MAX_PROC

#define MAX_PTHREAD MAX_THREAD
...
void start_thread();
void ClearPTCB(int exitval);



int isCOND_INIT(CondVar a);
...
int Read_2(Fid_t fd, char *buf, unsigned int size,int i);

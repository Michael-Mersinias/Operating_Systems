...
Tid_t InitializePTCB(PCB* pcb,TCB* new_thread,Task task, int argl, void* args);
...
TCB* spawn_thread_2(PCB* pcb, void (*func)(),Task task, int argl, void* args);
